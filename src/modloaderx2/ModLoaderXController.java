...
public class ModLoaderXController extends Application {
    ...
    public static ArrayList<String> loadedMods;
    ...
    public void helpButtonClicked()
    {
        ...
        alert.setTitle("Mod Loader X v0.2.8 help");
        alert.setHeaderText(null);
        alert.setContentText("Mod Loader X v0.2.8 was written in java 8 using javafx8 and was intended for use with the game Space Haven alpha 14.1.");
        alert.showAndWait();
    }
    ...
    { 
        ...
        primaryStage.setTitle("Mod Loader X v0.2.8");
